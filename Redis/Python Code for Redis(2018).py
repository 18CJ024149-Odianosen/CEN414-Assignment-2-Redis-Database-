...
def import_csv(key_col=1, csv_file="Homicides_Database9.csv", redis_host='127.0.0.1', redis_port=6379):
    pool = redis.ConnectionPool(host=redis_host, port=redis_port, db=11)
